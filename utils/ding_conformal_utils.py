# ============================================================================
# VENDORED VERBATIM from Ding, Angelopoulos, Bates, Jordan, Tibshirani (2023),
# "Class-Conditional Conformal Prediction with Many Classes".
# Source: https://github.com/tiffanyding/class-conditional-conformal
#         utils/conformal_utils.py
#
# Only two lines were changed, both marked [VENDORED] below:
#   1. `import torch` commented out. torch is used exclusively by the APS/RAPS
#      score helpers, which are not called here: scores.py provides a NumPy
#      implementation verified to agree with the original bit for bit.
#   2. the package-relative import of clustering_utils made flat.
# No calibration logic was modified.
# ============================================================================

import matplotlib.pyplot as plt
import numpy as np
# import torch  # [VENDORED] removed: only used by the score helpers, replaced by scores.py
...
from clustering_utils import embed_all_classes  # [VENDORED] relative -> flat import
